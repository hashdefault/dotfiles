...
local theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow_catppuccin"
...
theme.bg_normal = Subtext2
theme.bg_focus = Mauve
theme.bg_urgent = Text
theme.taglist_fg_focus = Surface0
theme.tasklist_bg_focus = "#000000"
theme.tasklist_fg_focus = Mauve
theme.border_width = 2
theme.border_normal = Subtext0
theme.border_focus = Lavender
theme.border_marked = Mauve
theme.titlebar_bg_focus = Text
theme.titlebar_bg_normal = Text
