...
theme.widget_bluetooth                           = theme.dir .. "/icons/bluetooth.png"
...
local bluetooth = wibox.widget.imagebox(theme.widget_bluetooth)
bluetooth:buttons(my_table.join(awful.button({}, 1, function() awful.spawn.with_shell("blueman-manager") end)))
